...
exports.postAddUserAccount = (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
        ...
        const userAccount = new UserAccount(password, email, firstname, lastname, phone, address, cart);
        userAccount
            .save()
            .then(result => {
                // console.log(result);
...
exports.postUpdateUserAccount = (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
        ...
        const userAccount = new UserAccount(password, email, firstname, lastname, phone, address, cart, new ObjectId(userAccount_id));
        userAccount
            .save()
            .then(result => {
